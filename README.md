...
- If user comes back from external payment site, payment state is checked server-to-server between OpenDxp and
...
<!-- Form to submit successful payment result to OpenDxp -->
