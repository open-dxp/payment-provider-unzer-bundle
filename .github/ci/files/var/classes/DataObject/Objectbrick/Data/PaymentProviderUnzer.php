...
public function getAuth_paymentMethod(): ?string
{
	...
	if(\OpenDxp\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_paymentMethod")->isEmpty($data)) {
		try {
...
public function getAuth_amount(): ?string
{
	...
	if(\OpenDxp\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_amount")->isEmpty($data)) {
		try {
...
public function getAuth_currency(): ?string
{
	...
	if(\OpenDxp\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_currency")->isEmpty($data)) {
		try {
...
public function getAuth_paymentType(): ?string
{
	...
	if(\OpenDxp\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_paymentType")->isEmpty($data)) {
		try {
...
public function getAuth_paymentReference(): ?string
{
	...
	if(\OpenDxp\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_paymentReference")->isEmpty($data)) {
		try {
...
public function getAuth_clientMessage(): ?string
{
	...
	if(\OpenDxp\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_clientMessage")->isEmpty($data)) {
		try {
...
public function getAuth_merchantMessage(): ?string
{
	...
	if(\OpenDxp\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_merchantMessage")->isEmpty($data)) {
		try {
...
public function getAuth_chargeId(): ?string
{
	...
	if(\OpenDxp\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_chargeId")->isEmpty($data)) {
		try {
